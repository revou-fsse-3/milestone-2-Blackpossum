...
const SignupPage = () => {
  ...
  return (
      <Container className="flex items-center justify-center h-[700px]">
        <Paper elevation={8} className="p-8 ml-20 max-w-md w-[500px] text-center" color="black">
          ...
          <form className="flex flex-col items-center gap-6" onSubmit={formik.handleSubmit}>
            ...
            <Button className="bg-primary w-[400px] h-[50px]" type="submit" variant="contained" color="primary">
              Sign Up
            </Button>
          </form>
        </Paper>
